...
export const DEFAULT_OG_IMAGE = `${SITE_URL}/asset/Icon_GHTXDBK.png`;
export const FACEBOOK_URL = 'https://www.facebook.com/civil.engineer.bk/';

export const SITE_DESCRIPTION =
  'GHTXDBK là nền tảng học tập xây dựng thực chiến với khóa học, blog chuyên môn và công cụ dành cho sinh viên, kỹ sư trẻ.';
