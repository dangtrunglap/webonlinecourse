...
const faqs = [
  {
    ...
    answer: 'Phù hợp với sinh viên xây dựng, người đang làm đồ án, người mới học Revit hoặc ETABS và kỹ sư trẻ muốn học theo hướng thực hành.',
  },
  {
    question: 'Website đang cung cấp những gì?',
    answer: 'Hiện tại nền tảng có khóa học, blog chuyên môn và khu vực công cụ hoặc gói hỗ trợ học tập.',
  },
  {
  ...
  {
    question: 'Tôi có thể đọc blog trước khi mua không?',
    answer: 'Có. Website có khu vực blog để bạn đọc trước nội dung chuyên môn, từ đó đánh giá mức độ phù hợp.',
  },
  {
